...
OCP_SUBRELEASE=4.6.7

# Must match directory at https://mirror.openshift.com/pub/openshift-v4/dependencies/rhcos/
RHCOS_RELEASE=4.6       # "4.5" for latest stable,  "pre-release" for nightly

# ancillary services
WEBROOT=/var/www/html
TFTPROOT=/var/lib/tftpboot		# Using dnsmasq container as tftpserver, otherwise /tftpboot or /var/lib/tftpboot
POCDIR=ocp4
...
prep_images () {
    ...
    cp -f ./images/rhcos-live-rootfs.x86_64.img    ${WEBROOT}/rhcos/rhcos-live-rootfs.img
